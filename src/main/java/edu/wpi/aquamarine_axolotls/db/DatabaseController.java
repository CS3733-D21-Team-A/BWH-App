...
public class DatabaseController {
	...
	private DatabaseController() throws SQLException, IOException {
		boolean dbExists = connectToDB(prefs.get(USE_CLIENT_SERVER_DATABASE, null) != null).getKey();
	...
	public boolean updateConnection() throws SQLException, IOException {
		shutdownDB();
		Pair<Boolean,Boolean> bools = connectToDB(prefs.get(USE_CLIENT_SERVER_DATABASE, null) != null);
